...
class Config {
  ...
  public static function is_set($name, $configName = 'ConfigMelanie') {
	...
	const NEED_ACTION_ATTENDEE = 'NEED_ACTION_ATTENDEE';
	const IS_SAVED_ATTENDEE = 'IS_SAVED_ATTENDEE';
	const IS_LIST_ATTENDEE = 'IS_LIST_ATTENDEE';
	const IS_INDIVIDUELLE_ATTENDEE = 'IS_INDIVIDUELLE_ATTENDEE';
	const IS_RESSOURCE_ATTENDEE = 'IS_RESSOURCE_ATTENDEE';
	const IS_EXTERNAL_ATTENDEE = 'IS_EXTERNAL_ATTENDEE';
	const UID_ATTENDEE = 'UID_ATTENDEE';
	const DELEGATED_FROM = "DELEGATED_FROM";
  	const DELEGATED_TO = "DELEGATED_TO";
	...
	const ALWAYS_SHOW_EVENT_CREATOR = 'ALWAYS_SHOW_EVENT_CREATOR';
	const SHARED_EVENT_CREATOR = 'SHARED_EVENT_CREATOR';
	const SHARED_EVENT_CREATOR_SELF = 'SHARED_EVENT_CREATOR_SELF';
	const SHARED_EVENT_CREATION_DATE_FORMAT = 'SHARED_EVENT_CREATION_DATE_FORMAT';
	const INVITATION_FORCE_SHARED_MAILBOX_EMAIL = 'INVITATION_FORCE_SHARED_MAILBOX_EMAIL';
