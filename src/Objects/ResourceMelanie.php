 ...
 * @subpackage ORM
 */
class ResourceMelanie extends MagicObject implements IObjectMelanie {
	/**
	...
	public function load() {
        ...
        $query = Sql\SqlMelanieRequests::getObjectById;


		// Replace name
		$query = str_replace('{user_uid}', MappingMce::$Data_Mapping[$this->objectType]['owner'][MappingMce::name], $query);
		$query = str_replace('{datatree_name}', MappingMce::$Data_Mapping[$this->objectType]['resource_name'][MappingMce::name], $query);
		...
		$query = str_replace('{datatree_id}', MappingMce::$Data_Mapping[$this->objectType]['id'][MappingMce::name], $query);
		$query = str_replace('{group_uid}', MappingMce::$Data_Mapping[$this->objectType]['type'][MappingMce::name], $query);
		$query = str_replace('{name}', MappingMce::$Data_Mapping[$this->objectType]['name'][MappingMce::name], $query);
