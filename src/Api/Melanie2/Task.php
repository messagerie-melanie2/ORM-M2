 ...
 */
class Task extends Melanie2Object {
   ...
   * 
   * @var TaskslistMelanie
   */
  protected $taskslistmelanie;
  /**
   ...
   * @param TaskslistMelanie $taskslistmelanie          
   */
  function __construct($usermelanie = null, $taskslistmelanie = null) {
    ...
    if (isset($taskslistmelanie)) {
      $this->taskslistmelanie = $taskslistmelanie;
      $this->objectmelanie->taskslist = $this->taskslistmelanie->id;
    }
  }
  ...
  /**
   * Défini la liste de tâches Melanie
   * 
   * @param TaskslistMelanie $taskslistmelanie          
   * @ignore
   *
   */
  function setTaskslistMelanie($taskslistmelanie) {
  ...
  public function setAttribute($name, $value) {
    ...
    if (!isset($value)) {
      ...
      if (isset($this->taskslistmelanie)) {
        $taskproperty->taskslist = $this->taskslistmelanie->id;
      } else {
        $taskproperty->taskslist = $this->taskslist;
      }
      $taskproperty->user = isset($this->owner) ? $this->owner : $this->usermelanie->uid;
  ...
  protected function setMapPriority($priority) {
    ...
    if (!isset($this->objectmelanie))
      throw new Exceptions\ObjectMelanieUndefinedException();
    $this->objectmelanie->priority = MappingMelanie::$MapPriorityObjectMelanie[$priority];
  }
  /**
   * Mapping priority field
   * 
  ...
  protected function getMapPriority() {
    ...
    if (!isset($this->objectmelanie))
      throw new Exceptions\ObjectMelanieUndefinedException();
    return MappingMelanie::$MapPriorityObjectMelanie[$this->objectmelanie->priority];
  }
