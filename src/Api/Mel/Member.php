...
class Member extends User {
    /**
     * Filtre pour la méthode load() avec un email specifique au member
     * 
     * @ignore
     */
    const LOAD_FROM_EMAIL_FILTER = "(&(mail=%%email%%)(|(objectClass=mineqMelBoite)(objectClass=mineqMelDP)))";
}