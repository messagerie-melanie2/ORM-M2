...
$notification->title = "Une autre notification";
$notification->content = "Encore une notification pour tester";
$notification->from = "thomas.payen@i-carre.net";
...
$user->readNotification('8c493307-d571-4e2d-b7d8-29bb412aafd8');
