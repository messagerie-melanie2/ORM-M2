...
class SqlMelanieRequests {
	 ...
	 * @param :user_uid, :pref_scope, :pref_name, :group_uid, :attribute_name, :attribute_perm, :attribute_permfg
	 */
	const functionGetDefaultObject = "SELECT datatree_id as {datatree_id}, user_uid as {user_uid}, datatree_name as {datatree_name}, datatree_ctag as {datatree_ctag}, datatree_synctoken as {datatree_synctoken}, attribute_value as {attribute_value}, perm_object as {perm_object} FROM getDefaultObject(:user_uid, :pref_scope, :pref_name, :group_uid, :attribute_name, :attribute_perm, :attribute_permfg);";
