 ...
 */
namespace LibMelanie\Api\Standard\Workspaces;
 ...
 * @api
 * 
 * @property integer $id Identifiant unique du share
 * @property string $user uid de l'utilisateur
 * @property RIGHT_* $rights droit de partage
 * 
 ...
 */
class Share extends Defaut\Workspaces\Share {}