...
class Cache {
   ...
   * @return boolean
   */
  static function setSQLToCache($table_name = null, $fields = null, $query = null, $params = null, $results = null) {
   ...
   */
  static function getFromSQLCache($table_name = null, $fields = null, $query = null, $params = null) {
    // Le cache est il activé
    if (!Config::get(Config::CACHE_ENABLED))
      return null;
    if (empty($table_name)) {
