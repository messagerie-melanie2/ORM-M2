...
class User extends Mce\User {
   ...
   * @ignore
   */
  const LOAD_ATTRIBUTES = ['fullname', 'uid', 'name', 'email', 'email_list', 'email_send', 'email_send_list', 'server_routage', 'shares', 'type','mcemailroutingaddress','outofoffices','mcedomain','mceVisibilite'];
  ...
  const MAPPING = [
    ...
    "locality"                => 'l',                             // Ville
    "title"                   => 'title',                         // Titre
    "gendmemberof"                => [MappingMce::name => 'gendmemberof', MappingMce::type => MappingMce::arrayLdap],
    ...
    "mailroutingaddress"   => [MappingMce::name => 'mailroutingaddress', MappingMce::type => MappingMce::arrayLdap], // routegemceadrressmail host
    ...
    "mcevisibilite"           => [MappingMce::name => 'mcevisibilite', MappingMce::type => MappingMce::arrayLdap]
  ];
